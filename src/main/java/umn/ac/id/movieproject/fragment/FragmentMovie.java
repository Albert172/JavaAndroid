package umn.ac.id.movieproject.fragment;
...
import umn.ac.id.movieproject.R;
import umn.ac.id.movieproject.activities.DetailMovieActivity;
import umn.ac.id.movieproject.adapter.MovieAdapter;
import umn.ac.id.movieproject.adapter.MovieHorizontalAdapter;
import umn.ac.id.movieproject.model.ModelMovie;
import umn.ac.id.movieproject.networking.ApiEndpoint;
