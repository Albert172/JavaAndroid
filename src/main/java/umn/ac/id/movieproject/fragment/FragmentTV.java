...
import umn.ac.id.movieproject.activities.DetailTelevisionActivity;
import umn.ac.id.movieproject.adapter.TvAdapter;
import umn.ac.id.movieproject.adapter.TvHorizontalAdapter;
import umn.ac.id.movieproject.model.ModelTV;
