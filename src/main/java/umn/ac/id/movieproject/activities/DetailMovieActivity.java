package umn.ac.id.movieproject.activities;
...
import umn.ac.id.movieproject.adapter.TrailerAdapter;
import umn.ac.id.movieproject.model.ModelMovie;
import umn.ac.id.movieproject.model.ModelTrailer;
import umn.ac.id.movieproject.networking.ApiEndpoint;
import umn.ac.id.movieproject.realm.RealmHelper;
